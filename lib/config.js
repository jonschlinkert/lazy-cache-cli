...
module.exports = function(app, base) {
  ...
  var lazyFile = path.resolve(cwd, 'utils.js');
  ...
  app.task('lazy', function(cb) {
    ...
    return app.src(templates('default.js'))
      ...
      .pipe(app.dest(function(file) {
        file.basename = 'utils.js';
        console.log('created', file.relative);
        return cwd;
      }));
  });
  ...
  app.task('learn', function(cb) {
    console.log('Learning variables in', path.relative(cwd, lazyFile));
    return app.src(lazyFile, {cwd: cwd})
